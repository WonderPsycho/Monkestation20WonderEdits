/datum/storyteller/hybrid
	...
	tag_multipliers = list(TAG_COSMIC = 1.12, TAG_BIOPUNK = 1.12, TAG_ALIEN = 0.9, TAG_SPOOKY = 0.10, TAG_COUNTERBIO = 0.4, TAG_COMMUNAL = 0.9, TAG_TARGETED = 1.3)
	weight = 2
	roundstart_points_variance = 50
	roundstart_prob = 5
	population_min = 25
